...
<body>
	...
	<div class="container">
		 ...
		 <div class="row">
		 	<div class="col-sm-12">
		 		<span class="btn btn-info" type="input" id="ventaProductosBtn">Vender Producto</span>
		 		<span class="btn btn-secondary" type="input" id="ventasHechasBtn">Ventas Hechas</span>
		 	</div>
		 </div>
		 <div class="row">
		 	<div class="col-sm-12">
